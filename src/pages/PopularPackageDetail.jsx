...
import popularPackageTours from "../models/popularPackageData";

const PopularPackageDetail = () => {
  const { slug } = useParams();
  const tour = popularPackageTours[slug] || null;
  ...
  const seoTitle = tour?.metaTitle || tour?.title || "Tour Package";
...
export default PopularPackageDetail;
